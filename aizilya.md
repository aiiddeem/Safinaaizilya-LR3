...
![Снимок экрана 2024-10-23 022635](https://github.com/user-attachments/assets/777aba7d-cab7-4f25-9829-a2b53ca42791)


![Снимок экрана 2024-10-23 022624](https://github.com/user-attachments/assets/4f01b4fe-96f7-4c03-aba5-27a93827668c)
...
код:
@startmindmap
'версия 02 обязанности
* Профессиональный стандарт для фотографа
** Общие положения
*** Описание профессии
*** Компетенции
...
**** Работа с моделями
**** Корректировка условий съёмки
*** Фотографирование
**** Композиция кадра
**** Работа со светом
**** Использование разных техник
** Обработка и публикация фотографий
*** Цифровая обработка
**** Цветокоррекция
**** Ретушь
**** Спецэффекты
*** Печать и подготовка к публикации
*** Форматы печати
*** Носители информации
...
![RPLTRjDG48NVimg_8VK9iO9kfL9vuA4LWYx0JjBIaaAXGg82GG4Xta1k6hUEyvCjpDqHtz7uEfTYHP7iEsVEd9bx9jbzURJtukZWsU7-mTxpmIERMXNoK5WTBhB7Jp9Rsqsui7ihRSLd7Oemj7gmazbro7aT0oy41xW2j0ZdjWeJcsT2AijcLi8up7XOG4hAciZQRY4eUIi7Ez1](https://github.com/user-attachments/assets/e166c401-fdaf-4c4d-ae9a-9c2dfa14d789)

Задание 29.

![XLRTQXDH4BxFKnpmGkXLAuYt1H_22_4YcD26fjkG1AHt-KdJrbIhHR0eMXNfdR9jSzhDfabUOSuR-StisNKRPeaWx3bdvfkPRxwPPhFLBZVRkxMWibjkb5exjQ1HRfPt3MwUrykjrejQfRrjDfuypRq5UvLggzem6-kvosOvsF6NfSTqJTPrN9SYTshMdnatb9iUXQMrbuzUxvU](https://github.com/user-attachments/assets/bbfdfe62-a0c0-40b3-b7c7-3e28b7128d22)
...
![image](https://github.com/user-attachments/assets/c9bca837-bcd8-40b6-88c1-6eb991d2281c)

Задане 33.

Аббревиатура WYSIWYG расшифровывается как What You See Is What You Get, что переводится на русский язык как «Что видишь, то и получаешь». Эта концепция относится к программному обеспечению, которое позволяет пользователям видеть содержимое документа таким же, каким оно будет выглядеть после печати или публикации. В контексте веб-разработки, например, WYSIWYG-редакторы позволяют пользователям форматировать текст и добавлять элементы дизайна непосредственно на странице без необходимости использования HTML-кода.

Задание 34.

![image](https://github.com/user-attachments/assets/8f8c2abe-efed-4d04-b404-2a8f0144c734)

Задание 35.

![image](https://github.com/user-attachments/assets/e9905295-680d-4b5c-8e3b-ed49f119812a)

Задание 36.

![image](https://github.com/user-attachments/assets/5f506fca-84d8-4c67-a4dd-de4576269542)
...
Jetty и Tomcat являются популярными серверами приложений Java. Они используются для развертывания веб-приложений на основе Java. Основные различия между ними включают следующие аспекты:

Jetty

Jetty - это легковесный сервер приложений, который часто используется в средах разработки и тестирования из-за его небольших размеров и простоты настройки. Он также может работать как простой HTTP-сервер или сервер WebSocket. Основные особенности Jetty:

- Простота установки и настройки: легко установить и настроить, особенно полезен для малых проектов.
- Малый размер: занимает меньше места и требует меньше ресурсов по сравнению с другими серверами приложений.
- Поддержка различных протоколов: поддерживает HTTP, HTTPS, WebSocket и другие современные протоколы.
- Прозрачность: упрощает отладку и диагностику проблем благодаря открытому исходному коду.

Tomcat

Tomcat - это полнофункциональный сервер приложений, который часто используется в промышленных масштабах для развертывания сложных веб-приложений. Он предлагает большую функциональность и поддерживает множество технологий и фреймворков. Основные особенности Tomcat:

- Полноценный сервер приложений: поддерживает все необходимые функции для развертывания Java EE-приложений.
- Широкая поддержка фреймворков: совместимость с большим количеством фреймворков, таких как Spring, Hibernate и других.
- Поддержка кластеров: позволяет создавать и управлять высокодоступными системами.
- Расширяемость: широкие возмож

Задание 39-41.
Не удалось выполнить задание из-за отсутсвия доступа к странице
![image](https://github.com/user-attachments/assets/18ded303-ee8a-4c15-a29c-1e4c3c059076)
